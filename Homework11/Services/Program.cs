...
namespace Services
{
    class Program
    {
        static void Main()
        {
            ...
            Console.WriteLine("\n*****test change order detial*****\n");
            //show order 0
            Console.WriteLine(service.Select(o => o.OrderID == 0));
            ...
            Console.WriteLine("\n*****test change client and discount*****\n");
            //show order 1
            Console.WriteLine(service.Select(o => o.OrderID == 1));
            //change client
            ...
            service.Sort();
            service.Select(o => true).ForEach(o => Console.WriteLine(o));
            //sort according to customer ID
            Console.WriteLine("-----sort according to customer ID-----");
            service.Sort((o1, o2) => { return o1.Client.ClientID - o2.Client.ClientID; });
            service.Select(o => true).ForEach(o => Console.WriteLine(o));
            ...
            //test export & import
            Console.WriteLine("-----export to orders XML-----"); 
            try
            {
            ...
            Console.WriteLine(File.ReadAllText("../../../xml/orders.xml"));
            service.Import("orders");
            Console.WriteLine("-----import according to orders XML-----");
            service.Select(o => true).ForEach(o => Console.WriteLine(o));
